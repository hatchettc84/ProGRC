...
export class UpdateNewSSPTemplateReportSection1738220712756 implements MigrationInterface {
...
{recommendation_plan_table}</p>' where template_id = 4 and section_id = 'c7b0881c-8187-40f1-8801-66f273d84332';
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            UPDATE public.templates_section set 
html_content = '<h1>Documented and Assessed Control</h1>
<h2>{control_family_name}</h2>
<h3>{control_id} {control_name}</h3>
<h4>{control_id} Control Discussion</h4>
<p>{control_text}</p>
