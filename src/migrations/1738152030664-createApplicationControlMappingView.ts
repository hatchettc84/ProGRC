...
export class CreateApplicationControlMappingView1738152030664 implements MigrationInterface {
        ...
        await queryRunner.query(`
            ...
            SELECT id,
                   ...
                   CASE
                       ...
                       ELSE 1
                   END AS is_user_modified_explaination,
                   CASE
                   ...
                   CASE
                       WHEN user_implementation_status IS NULL OR user_implementation_status = '' THEN
                           CASE
                               ...
                               WHEN implementation_status = 'partially_implemented' THEN 50
                       ...
                       ELSE
                           CASE
                               ...
                               WHEN user_implementation_status = 'partially_implemented' THEN 50
